...
from models import get_model_without_adapter
...
if __name__=="__main__":
    ...
    parser.add_argument("--batch_size", type=int, default=128, help="Batch size for training and testing") # suboptimal (using only 4GB of GPU memory) but same one as in RanPAC
    ...
    parser.add_argument("--save_dir", type=str, default="linear_mocov3/checkpoints", help="Directory to save checkpoints")
    parser.add_argument("--log_dir", type=str, default="linear_mocov3/runs", help="Directory to save logs")
    ...
    for epoch in range(args.num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join(args.save_dir, f"checkpoint_{epoch}.pth"))
