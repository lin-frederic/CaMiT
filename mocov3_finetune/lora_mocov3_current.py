...
if __name__=="__main__":
    ...
    train_dataset = SupervisedTimeDataset(args.train_annotations, args.train_images_dir, args.pretraining_year , transform=preprocess_train)
    train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)

    test_dataset = SupervisedTimeDataset(args.test_annotations, args.test_images_dir, args.pretraining_year , transform=preprocess_val)
    ...
    for epoch in range(args.num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join(args.save_dir, f"checkpoint_{args.pretraining_year}_current_{epoch}.pth"))
