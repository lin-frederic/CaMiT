...
def parse_args():
    ...
    parser.add_argument("--model_size", type=str, default="s", help="Model size (s, b,l)")
    parser.add_argument("--model_path", type=str, default="lora_mocov3/checkpoints_s/checkpoint_19.pth", help="Path to the model checkpoint")
    parser.add_argument("--pretrained_model_path", type=str, default="initial_pretrain_with_train/checkpoints/checkpoint_0199.pth.tar", help="Path to pre-trained model checkpoint")
