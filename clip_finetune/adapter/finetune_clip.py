...
if __name__=="__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="finetune_clip/checkpoints", help="Directory to save checkpoints")
    parser.add_argument("--log_dir", type=str, default="finetune_clip/runs", help="Directory to save logs")

    args = parser.parse_args()
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    model_size = args.model_size
    model, preprocess_train, preprocess_val = clip_adapter(model_size)
