...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, help="Path to data", default=os.path.join(os.environ['HOME'], 'pretraining_car_images'))
    parser.add_argument("--dest_path", type=str, help="Path to save images", default=os.path.join(os.environ['HOME'], 'pretraining_car_detections'))
    ...
    parser.add_argument("--job", type=int, help="Job number", default=0)
    parser.add_argument("--num_jobs", type=int, help="Number of jobs", default=8)
    ...
    class_names.sort()
    # split classes into jobs
    n_classes = len(class_names)// args.num_jobs
    start = args.job * n_classes
    end = (args.job + 1) * n_classes if args.job != args.num_jobs - 1 else len(class_names)
