...
with open("outputs/train_gpt_annotations_with_unknown.json", "w") as f:
    json.dump(gpt_annotations, f)
with open("outputs/test_gpt_annotations_with_unknown.json", "w") as f:
    json.dump(test_gpt_annotations, f)
with open("outputs/gpt_class_mapping_with_unknown.json", "w") as f:
