...
if __name__=="__main__":
    ...
    parser.add_argument("--results_missing", type=str, default='face_blurring/insightface_results_pretrain_supplementary_final_2008_2023_missing', help="path to the missing results directory")
    ...
    with open('pretrain_annotations_with_faces2.json', 'w') as f:
