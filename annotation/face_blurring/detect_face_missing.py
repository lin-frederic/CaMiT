...
if __name__ == '__main__':
    ...
    parser.add_argument("--annotations", type=str, default='pretrain_annotations.json', help="path to the pretrain annotations file")
    parser.add_argument("--missing_images", type=str, default='face_blurring/missing_images.txt', help="path to the missing images file")
    parser.add_argument("--save_dir", type=str, default='face_blurring/insightface_results_pretrain_missing', help="path to the output directory") 
