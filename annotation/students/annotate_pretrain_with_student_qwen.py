...
if __name__ == '__main__':
    ...
    parser.add_argument("--checkpoint_path", type=str, default="/home/users/flin/cars_time/finetune_qwen/best_checkpoint.pth", help="Path to the checkpoint file")
    parser.add_argument("--batch_size", type=int, default=4096, help="Batch size for inference")
    parser.add_argument("--num_workers", type=int, default=8, help="Number of workers for data loading")
    parser.add_argument("--output_file", type=str, default="outputs/pretrain_annotations_with_qwen_student.json", help="Output file for the results") 
