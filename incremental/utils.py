...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="dinov2", help="Model to use (dinov2 or clip)")
    parser.add_argument("--model_size", type=str, default="b", help="Model size (s, b,l)")
    parser.add_argument("--epoch", type=int, default=299, help="Epoch to use for the model")
    parser.add_argument("--car_mocov3_dir", type=str, default="checkpoints", help="Path to car_mocov3 checkpoints directory")
