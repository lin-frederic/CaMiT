...
if __name__ == "__main__":
    ...
    year_models = [f"{model_name}_{year}_replay" for year in years]
    years.insert(0, "2007")
    ...
    plt.title("Evolution of Average Accuracies Over Years (replay)", fontsize=16)
    ...
    # Show the plot
    plt.tight_layout()
    plt.savefig("average_accuracies_over_years_replay.png")
    plt.show()