...
if __name__=="__main__":
    ...
    # Save results
    os.makedirs("fecamv2_results", exist_ok=True)
    os.makedirs(f"fecamv2_results/{model_name}", exist_ok=True)
    with open(os.path.join(f"fecamv2_results/{model_name}", f"results_{args.job_id}.json"), "w") as f:
